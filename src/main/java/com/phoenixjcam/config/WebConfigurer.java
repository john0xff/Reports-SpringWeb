...
public class WebConfigurer extends WebMvcConfigurerAdapter
{
	...
	public SessionFactory sessionFactory()
	{
		...
		builder.scanPackages("com.phoenixjcam.products.model").addProperties(getHibernateProperties());
		builder.scanPackages("com.phoenixjcam.orderdetails.model").addProperties(getHibernateProperties());
	...
	public BasicDataSource dataSource()
	{
		...
		ds.setUrl("jdbc:mysql://localhost:3306/db_jv_crm");
